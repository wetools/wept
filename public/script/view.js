      ...
      var s = !1,
        ...
        u = {
          ...
          onWxmlChange: function (e) {
            r.subscribe('reload', function(data) {
      ...
      xhr.onreadystatechange = function() {
        if (xhr.readyState === 4) {
          if (xhr.status === 200) {
            ...
            var oldTree = curr
            var o = m(u.default.getData(), false)

            var dTree = oldTree.diff(o);

            dTree.apply(y),  document.dispatchEvent(new CustomEvent("pageReRender", {}));
