/*global WeixinJSBridge, __wxConfig, __wxRoute*/
var wx = function(e) {
    function t(o) {
  ...
  __appServiceEngine = function(e) {
    ...
    var o = n(2);
    Object.defineProperty(t, "Reload", {
      enumerable: !0,
      get: function() {
        return o.pageReloader
      }
    });
    ...
    Object.defineProperty(t, "__esModule", {
      value: !0
    }), t.getRouteToPage = t.getWebviewIdToPage = t.setWxRouteBegin = t.setWxRoute = t.setWxConfig = t.reset = t.pageHolder = t.pageReloader = t.getCurrentPage = void 0;
    var r = n(1),
      i = n(6),
      a = o(i),
      u = n(1),
      ...
      g = (t.getCurrentPage = function() {
        ...
        if (!window.__wxRouteBegin) throw (0, u.error)("Page注册错误", "不要在 " + __wxRoute + ".js 注册多个Page"), new r.AppServiceEngineKnownError("Please do not register multiple Page in " + __wxRoute + ".js");
        window.__wxRouteBegin = false;
        ...
        //exists && e.onLoad && e.onLoad(query)
      },function(e, t, n) {
        var o = void 0;
        ...
        (0, u.isDevTools)() && (window.__wxAppData[e] = r.data, window.__wxAppData[e].__webviewId__ = t, (0, u.publish)(c.UPDATE_APP_DATA)), s = {
          page: r,
          webviewId: t,
          route: e
      ...
      y = function(e) {
        e.page.onUnload(), (0, u.isDevTools)() && (delete window.__wxAppData[e.route], (0, u.publish)(c.UPDATE_APP_DATA)), delete p[e.webviewId]
      },
      w = function(e, t, n, o) {
  ...
  var Reload = window.Reload = __appServiceEngine.Reload;
  var Page = window.Page = __appServiceEngine.Page;
  var App = window.App = __appServiceEngine.App;
  var getApp = window.getApp = __appServiceEngine.getApp;
!function() {
  var e = 1,
    t = 2,
    n = {},
  ...
  Object.definePropert ? (Object.defineProperty(window, "require", {
    enumerable: !1,
    configurable: !1,
    writable: !1,
    value: require
